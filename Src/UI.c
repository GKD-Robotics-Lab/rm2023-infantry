...
int String_ReFresh(String_Data string_Data)
{
    ...
    framepoint = (unsigned char *)&imageData;
    frametail =
        Get_CRC16_Check_Sum_UI(framepoint, sizeof(imageData), frametail);  // CRC16校验   //CRC16校验值计算（部分）
...
void UI_set_control(UI_control_t *UI)
{
    ...
    if (UI_control.fric_mode != UI_control.fric_open)
    {
        Line_Draw(
            ...
            UI_Graph_ADD,
            9,
            UI_control.fric_open ? UI_Color_Green : UI_Color_Main,
            5,
            FRIC_NAME_START_X,
            FRIC_NAME_START_Y,
            FRIC_NAME_START_X + 20,
    ...
    if (UI_control.spin_mode != UI_control.spin_open)
    {
        Line_Draw(
            ...
            UI_Graph_ADD,
            9,
            UI_control.spin_open ? UI_Color_Green : UI_Color_Main,
            5,
            SPIN_NAME_START_X,
            SPIN_NAME_START_Y,
            SPIN_NAME_START_X + 20,
