...
extern gimbal_yaw_direction_e gimbal_yaw_direction;  // yaw��̨��ǰ�����
...
void chassis_rc_to_control_vector(fp32 *vx_set, fp32 *vy_set, chassis_move_t *chassis_move_rc_to_vector)
{
    ...
    else if (chassis_move_rc_to_vector->chassis_RC->key.v & CHASSIS_BACK_KEY)
    {
		...
		else if(xTaskGetTickCount() - last_key_tick < 800)  //���û�а��°����������б�����  (���ڼ��̺�ң�������л�)
		{
//				ramp_to_zerro(&chassis_move_rc_to_vector->key_vx_ramp, RAMP_KEY_ADD_VX * 7);  // �𽥼�С��0����б�ʸ���
    ...
    else if (chassis_move_rc_to_vector->chassis_RC->key.v & CHASSIS_RIGHT_KEY)
    {
		...
		{
//				ramp_to_zero(&chassis_move_rc_to_vector->key_vy_ramp, RAMP_KEY_ADD_VY * 7);  // �𽥼�С��0����б�ʸ���
...
static void chassis_set_contorl(chassis_move_t *chassis_move_control)
{
    ...
    if (chassis_move_control->chassis_mode == CHASSIS_VECTOR_FOLLOW_GIMBAL_YAW)
    {
        ...
        //���ÿ��������̨�Ƕ�
        chassis_move_control->chassis_relative_angle_set = rad_format(angle_set);  //��ģʽ�����������ҡ�ڣ�angle_setʼ��Ϊ0
    ...
    else if (chassis_move_control->chassis_mode == CHASSIS_VECTOR_NO_FOLLOW_YAW)
    {
        ...
        //��angle_set�� ����ת�ٶȿ���
				...
				chassis_move_control->vy_set = fp32_constrain(chassis_move_control->vy_set, chassis_move_control->vy_min_speed, chassis_move_control->vy_max_speed);
				// ����wz
				if(chassis_behaviour_mode == CHASSIS_SPIN)  // �������С����ģʽ
				{
					chassis_move_control->wz_set = angle_set;
				}
				else  // ���δ��С����ģʽ (angle_set����ң����, chassis_no_follow_angle_pid�����Խ������ٶȻ�������)
				{
					//���ÿ��������̨�Ƕ�
